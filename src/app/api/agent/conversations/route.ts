...
/** GET /api/agent/conversations → lista del usuario */
...
/** POST /api/agent/conversations → crear o actualizar (upsert) */
export async function POST(req: Request) {
    try {
        ...
        // Auto-generar título del primer mensaje del usuario si no se provee
