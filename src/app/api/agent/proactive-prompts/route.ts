...
/** GET /api/agent/proactive-prompts → lista prompts pendientes del usuario */
...
/**
 * POST /api/agent/proactive-prompts
 * Body: { action: 'resolve', id: string, status: 'accepted' | 'dismissed' }
 *     o { action: 'generate', insights: [...] }
 */
